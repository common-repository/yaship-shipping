...
class Yaship_Boxpack{
	...
	public function add_box( $length, $width, $height, $weight = 0 ) {
		...
		$new_box = new Yaship_Box( $length, $width, $height, $weight );
		$this->boxes[] = $new_box;
	...
	public function add_item( $length, $width, $height, $weight, $value = '', $meta = array() ) {
		...
		$this->items[] = new Yaship_Item( $length, $width, $height, $weight, $value, $meta );
...
/**Class Which represent any box in shipping**/
class Yaship_Box{
	...
	public function pack( $items ) {
		...
		//Try to pack all items in all boxes one by one--KI
		//unpacked is an array of items witch can not pack in any type--KI
...
/**Class Represents items to be packed inside the boxes**/
class Yaship_Item{
	public $weight;
	public $height;
	public $width;
